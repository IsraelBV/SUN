$(document).ready(function () {
    ...
    $("#btnTransferEmpresa").click(function () {
        ...
        var IdEmpresaFiscal = $("#EmpresaFiscal").val();
        console.log(IdEmpresaFiscal);
        var IdEmpresaComplemento = $("#EmpresaComplemento").val();
        console.log(IdEmpresaComplemento);
        var IdEmpresaAsimilado = $("#EmpresaAsimilado").val();
        console.log(IdEmpresaAsimilado);
        var IdEmpresaSindicato = $("#EmpresaSindicato").val();
        console.log(IdEmpresaSindicato);
        var fechaIMSS = $("#fechaIMSS").val();
        console.log(fechaIMSS);
