...
namespace SS.WEB.Controllers
{
    ...
    {
        readonly Empresas empresas = new Empresas();
        ...
        public JsonResult ReporteIncapacidad(int idEmpresa, DateTime fechaI, DateTime fechaF, int tipoReporte)
        {
            ...
            //0: reporte General, 1: reporte detallado.
            archivoReporte = (tipoReporte == 0) ? ReportesImss.GenerarReporteIncapacidades(idUsuario, fechaI, fechaF, idEmpresa, ruta, pathDescarga) : ReportesImss.GenerarReporteIncapacidades2(idUsuario, fechaI, fechaF, idEmpresa, ruta, pathDescarga);
        ...
        {
            var lista = empresas.getEmpresasByUser(Session["Usuario"] as SYA_Usuarios);
            return View(lista);
        }
